...
namespace CheckOver.Migrations
{
    ...
    [Migration("20210327202239_fixExercise")]
    partial class fixExercise
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserAssignment", b =>
                {
                    ...
                    b.HasKey("ApplicationUsersId", "AssignmentsId");

                    b.HasIndex("AssignmentsId");

                    b.ToTable("ApplicationUserAssignment");
                });
            ...
            modelBuilder.Entity("CheckOver.Models.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationUserAssignment", b =>
                {
                    ...
                    b.HasOne("CheckOver.Models.Assignment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CheckOver.Models.Assignment", b =>
                {
                    b.HasOne("CheckOver.Models.Invitation", "Invitation")
                        .WithMany()
